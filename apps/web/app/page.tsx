...
export const metadata: Metadata = {
  title: "SwiftTab — Next-Gen QR Dining & Revenue Platform",
  description:
    "The modern guest ordering and kitchen intelligence platform for restaurants. High-resolution studio food photography, live nutrition tracking, smart pairing upsells, and 0% commission direct UPI payments.",
  alternates: { canonical: "/" },
  openGraph: {
    title: "SwiftTab — Next-Gen QR Dining & Kitchen Intelligence",
    description:
      "Stunning studio food photography, real-time macro tracking, and zero commission QR ordering for modern restaurants.",
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-base sm:text-lg leading-relaxed text-slate-300 max-w-2xl font-normal">
                Replace flat paper menus with stunning studio-grade food photography, real-time calorie and protein intelligence, smart pairing upsells, and 1-tap WhatsApp digital bills — built to maximize table spend and kitchen speed.
              </p>
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-3xl bg-[#0B1512] border border-emerald-500/20 p-5 shadow-[0_20px_50px_rgba(0,0,0,0.6)] overflow-hidden backdrop-blur-xl">
                ...
                {/* Visual Menu Showcase Preview Widget */}
                <div className="py-4 space-y-3.5">
                  <div className="relative h-60 rounded-2xl overflow-hidden bg-gradient-to-b from-[#11201B] to-[#0B1512] flex items-center justify-center border border-emerald-500/15 group cursor-pointer">
                    <div className="relative w-44 h-44 rounded-full p-2 bg-emerald-950/40 border border-emerald-500/25 shadow-2xl transform group-hover:scale-105 transition-all duration-700">
                      <Image
                    ...
                    <div className="absolute bottom-2.5 left-3 right-3 flex items-center justify-between pointer-events-none">
                      <span className="px-2.5 py-1 rounded-md bg-[#070D0B]/85 backdrop-blur-md text-[10px] font-bold text-white border border-emerald-500/20 flex items-center gap-1.5">
                        <Sparkles className="w-3 h-3 text-emerald-400" /> Studio Quality
                      </span>
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-emerald-950/40 text-slate-300">
                  ...
                  <tr>
                    ...
                    <td className="py-4 text-emerald-400 font-bold">High-Res Studio Photos</td>
      ...
      <section className="py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl px-6 text-center relative">
          ...
          <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-2xl mx-auto">
            Join forward-thinking restaurants replacing flat paper menus with visual QR ordering, macro tracking, and 0% commission UPI settlements.
          </p>
